        ...
        <div class="box">
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="path_kartu_pelanggan" class="col-lg-2 control-label">Kartu Pelanggan</label>
                        <div class="col-lg-4">
                            <input type="file" name="path_kartu_pelanggan" class="form-control" id="path_kartu_pelanggan"
                                onchange="preview('.tampil-kartu-pelanggan', this.files[0], 300)">
                            <span class="help-block with-errors"></span>
                            <br>
                            <div class="tampil-kartu-pelanggan"></div>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    function showData() {
        $.get('{{ route('setting.show') }}')
            .done(response => {
                ...
                $('.tampil-kartu-pelanggan').html(`<img src="{{ url('/') }}${response.path_kartu_pelanggan}" width="300">`);
