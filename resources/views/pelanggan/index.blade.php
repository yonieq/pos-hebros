    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <button onclick="cetakBarang('{{ route('pelanggan.cetak_pelanggan') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-id-card"></i> Cetak Pelanggan</button>
            </div>
