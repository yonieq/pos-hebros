                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <input type="hidden" name="id_pelanggan" id="id_pelanggan" value="{{ $pelangganSelected->id_pelanggan }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="kode_pelanggan" value="{{ $pelangganSelected->kode_pelanggan }}">
                                        <span class="input-group-btn">
                                            <button onclick="tampilPelanggan()" class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
